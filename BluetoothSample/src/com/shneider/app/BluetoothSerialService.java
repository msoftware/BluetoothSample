...
public class BluetoothSerialService {
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        bundle.putString(Const.KEY_DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            while (true) { 
                try {
                    ...
                    mHandler.obtainMessage(Const.MESSAGE_READ, bytes, -1, buffer.clone()).sendToTarget();
                } catch (IOException e) {
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(Const.MESSAGE_WRITE, buffer.length, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
